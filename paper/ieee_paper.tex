...
\title{A Multi-Objective Optimization Framework for\\
       ...
       \url{https://github.com/ankitmewada1501/MTP_FINAL_CODE}.}}

\author{
\IEEEauthorblockN{Ankit Mewada}
\IEEEauthorblockA{\textit{Dept.\ of IT, ABV-IIITM} \\
Roll No.\ 2021IMT-013\\
Gwalior, India \\
ankitmewada0106@gmail.com}
\and
\IEEEauthorblockN{Aditya Trivedi}
\IEEEauthorblockA{\textit{Dept.\ of IT, ABV-IIITM} \\
Gwalior, India \\
atrivedi@iiitm.ac.in}
\and
\IEEEauthorblockN{Saumya Bhadauria}
\IEEEauthorblockA{\textit{Dept.\ of CSE, ABV-IIITM} \\
Gwalior, India \\
saumya@iiitm.ac.in}
}
...
that span $49\%\!-\!100\%$ coverage, giving the decision maker a rich menu
...
\item \textbf{Jointly} optimises four objectives (capex, radius-based
      ...
      MOPSO.
\item To capture uncertainty, the models employ independent per-station Monte Carlo noise alongside a logistic EV adoption curve.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.95\linewidth]{NSGA2-conv.png}
...
frontier from $\sim\!\text{\rupee}39$\,L/49\% coverage up to
$\sim\!\text{\rupee}400$\,L/100\% coverage; the average marginal
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.98\linewidth]{MOPSO-ROI.png}
...
(Fig.~\ref{fig:wq}) is distributed in $[0.18, 6.3]$\,min, well
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.98\linewidth]{queue-waiting.png}
  \caption{Real (penalty-free) mean queue wait per Pareto solution.
           Median: 1.2\,min (NSGA-II), 2.0\,min (MOPSO).}
  \label{fig:wq}
\end{figure}
...
span $\text{\rupee}1.3$\,Cr$\,$--$\,\text{\rupee}11.7$\,Cr/yr, with
...
\begin{figure}[t]
  \centering
  \includegraphics[width=.98\linewidth]{Annual_profit.png}
...
\begin{table}[t]
  ...
  \begin{tabular}{lrrr}
    ...
    \midrule
    NSGA-II   & $1.00\!\times\!10^{9}$  & $3.36\!\times\!10^{4}$ & 0.65 \\
    MOPSO     & $1.16\!\times\!10^{9}$  & $5.20\!\times\!10^{3}$ & 0.87 \\
    \bottomrule
  \end{tabular}
\end{table}
